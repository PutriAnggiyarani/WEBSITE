        ...
        <div class="row h-100">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p style="color: #595959;">Anda dapat memesan sebagai "Tamu", tetapi kami akan mengarahkan Anda
                        untuk mendaftarkan akun agar proses pembayaran dan pembayaran lebih cepat. Anda dapat memeriksa
                        status pesanan dan tidak perlu memasukkan kembali detail pelanggan setiap kali ingin melakukan
                        pembelian.
                    </p>
                    <p style="color: #595959; font-weight: bold;">SAYA LUPA KATA SANDI SAYA. APA YANG HARUS SAYA
                        LAKUKAN?</p>
                    <p style="color: #595959;">Klik tautan "Lupa Kata Sandi?" di Halaman LOGIN dan ikuti petunjuknya.
                    </p>
                    <p style="color: #595959; font-weight: bold;">SAYA INGIN MEMESAN BARANG YANG SUDAH HABIS TERJUAL.
                        APAKAH MUNGKIN?</p>
                    <p style="color: #595959;">Tidak, tetapi kami akan memberi tahu Anda saat stok tersedia kembali.
                        Pastikan Anda telah mendaftar sebagai anggota untuk mendapatkan informasi terbaru.
                    </p>
                    <p style="color: #595959; font-weight: bold;">DAPATKAH SAYA MEMASUKKAN ALAMAT YANG BERBEDA DI PROFIL
                        SAYA?</p>
                    <p style="color: #595959;">Ya. Harap tambahkan alamat baru Anda di bawah: profil -> alamat ->
                        tambahkan alamat baru.
                    </p>
                    <p style="color: #595959; font-weight: bold;">APAKAH FMD.ID MENERIMA PENGIRIMAN KE BANYAK ALAMAT?
                    </p>
                    <p style="color: #595959;">Sayangnya, kami tidak melayani pengiriman. Anda harus membuat pesanan
                        yang berbeda untuk mengirimkannya ke alamat yang berbeda.
                    </p>
                    <p style="color: #595959; font-weight: bold;">APAKAH SAYA DAPAT MENGGANTI ALAMAT PENGIRIMAN SETELAH
                        PESANAN SAYA DIKIRIM?</p>
                    <p style="color: #595959;">Sayangnya, Anda tidak dapat melakukannya. Kami hanya mengirimkan pesanan
                        ke alamat yang tertera.
                    </p>
                    <p style="color: #595959; font-weight: bold;">APAKAH SAYA DAPAT MENAMBAH BARANG SETELAH SAYA
                        MELAKUKAN PEMBAYARAN?</p>
                    <p style="color: #595959;">Sayangnya, Anda tidak dapat melakukannya, karena setelah melakukan
                        pembayaran pesanan Anda akan tercatat. Jika Anda ingin menambahkan barang, silakan buat pesanan
                        baru tanpa harus keluar dari sistem.
                    </p>
                    <p style="color: #595959; font-weight: bold;">APAKAH SAYA DAPAT MEMBAYAR DENGAN KARTU KREDIT?</p>
                    <p style="color: #595959;">Ya, Anda dapat melakukannya. Anda dapat membayar di situs web kami dalam
                        mata uang IDR. Keduanya diproses setelah mengklik tombol "Konfirmasi Pesanan".
                    </p>
                    ...
                    <p style="color: #595959; font-weight: bold;">APAKAH MUNGKIN MENJADI MITRA UNTUK TOKO BUTTONSCARVES?
                    </p>
                    <p style="color: #595959;">Ya, mungkin. Jika Anda tertarik untuk menjadi mitra kami, silakan
                        hubungi: info@fmd.co.id dengan subjek MITRA TOKO.
                    </p>
                    <br>
                    <form id="form" onsubmit="return validateForm()">
                        ...
                        <p style="color: #595959; font-weight: bold; display: inline;">Apakah BSLady bersedia hadir ke
                            lokasi event (Surabaya)?:</p><span style="color: red; font-weight: bold;">*</span>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="hadirEvent" id="yes" value="Yes">
                            <label class="form-check-label" for="yes">Yes</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="hadirEvent" id="no" value="No">
