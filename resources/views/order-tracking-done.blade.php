            ...
            <div id="order-tracking" class="w-100">
                <div class="navbar-order px-4 py-4 rounded-4">
                    ...
                    <ul id="progressbar-1-done" class="px-4 py-4 d-flex align-items-center">
                        ...
                        <li class="step0 active text-muted d-flex justify-content-center flex-column align-items-center text-center" id="step3"><span class="mt-2 fw-semibold">Pesanan Dikemas</span></li>
                        <li class="step0 active text-muted d-flex justify-content-center flex-column align-items-center text-center" id="step4"><span class="mt-2 fw-semibold">Pesanan Dikirim</span></li>
                        <li class="step0 active text-muted d-flex justify-content-center flex-column align-items-center text-center" id="step5"><span class="mt-2 fw-semibold">Belum Dinilai</span></li>
                    </ul>
                    <div class="btn-container">
                        <div class="d-flex justify-content-end px-md-5 mt-4">
                            <div class="d-flex flex-column">
                                ...
                                <a href="" class="btn btn-primary btn-edit-images rounded-4 mt-3">Beli Lagi</a>
                            </div>
