        ...
        <div class="card">
            <div class="card-body">
                <div class="card-sales-split">
                    ...
                    <ul>
                        <li>
                            <a href="javascript:void(0);"><img src="{{ url('assets/img/icons/edit.svg') }}"
                                    alt="img"></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);"><img src="{{ url('assets/img/icons/pdf.svg') }}"
                                    alt="img"></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);"><img src="{{ url('assets/img/icons/excel.svg') }}"
                                    alt="img"></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);"><img src="{{ url('assets/img/icons/printer.svg') }}"
                                    alt="img"></a>
                        </li>
                    </ul>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                <td style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                    <img src="{{ url('assets/img/product/product1.png') }}" alt="img" class="me-2"
                            ...
                            <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                <td style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                    <img src="{{ url('assets/img/product/product2.png') }}" alt="img" class="me-2"
                                        style="width:40px;height:40px;">
                                    Button Up Charm
                                </td>
                                <td style="padding: 10px;vertical-align: top; ">
                            ...
                            <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                <td style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                    <img src="{{ url('assets/img/product/product8.jpg') }}" alt="img" class="me-2"
                                        style="width:40px;height:40px;">
                                    Hijab Paris Premium
                                </td>
                                <td style="padding: 10px;vertical-align: top; ">
