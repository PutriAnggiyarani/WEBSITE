...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <!-- <div class="page-btn">
                <a href="addcustomer.html" class="btn btn-added"><img src="{{ url('assets/img/icons/plus.svg') }}"
                        alt="img">Add
                    Customer</a>
            </div> -->
        </div>
                    ...
                    <table class="table  datanew">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{ url('assets/img/customer/customer1.jpg') }}" alt="product">
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{ url('assets/img/customer/customer2.jpg') }}" alt="product">
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{ url('assets/img/customer/customer3.jpg') }}" alt="product">
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{ url('assets/img/customer/customer4.jpg') }}" alt="product">
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{ url('assets/img/customer/customer5.jpg') }}" alt="product">
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a href="javascript:void(0);" class="product-img">
                                        <img src="{{ url('assets/img/customer/customer6.jpg') }}" alt="product">
                                    </a>
