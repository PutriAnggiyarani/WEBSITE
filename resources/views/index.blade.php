        ...
        <div class="container-fluid mt-5  h-100">
            <div class="row h-100">
                <div class="col-6 col-md-3 d-flex justify-content-center">
                    <a href="{{ Request::route()->getName() === 'index-login' ? route('detailproduct') : route('bl-detailproduct') }}"
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center mt-4">
                    <a href="{{ route('produkbaru') }}" class="btn btn-arrow btn-custom-width btn-primary mt-3">
...
<section id="about-us" class="mt-5">
    <div class="container-fluid padding-side" data-aos="fade-up">
        ...
        <div class="container-fluid mt-5 h-100">
            <div class="row h-100">
                <div class="col-6 col-md-3 d-flex justify-content-center">
                    <a href="{{ Request::route()->getName() === 'index-login' ? route('detailproduct') : route('bl-detailproduct') }}"
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-semibold">Hijab Bella Square</h5>
                            <div class="star-rating">
                                <span class="fa fa-star checked" style="color: #fcaf23"></span>
                                <span class="fa fa-star checked" style="color: #fcaf23"></span>
                                <span class="fa fa-star checked" style="color: #fcaf23"></span>
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center mt-4">
                    <a href="{{ route('produkterlaris') }}" class="btn btn-arrow btn-custom-width btn-primary mt-3">
                        <span>
