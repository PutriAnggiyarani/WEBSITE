...
<header>
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ url('assets/images/ktgmukenah/banner.png')}}" alt="Shop Image 1" class="img-fluid">
        </div>
    </div>
</header>
    ...
    <div class="content">
        ...
        <div class="flex-wrapper">
            ...
            <div class="product-list">
                <div class="products">
                    <div class="product">
                        <img src="{{ url('assets/images/ktgmukenah/1.png') }}" alt="Hijab Bella Square">
                    ...
                    <div class="product">
                        <img src="{{ url('assets/images/ktgmukenah/2.png') }}" alt="Hijab Segitiga Inner">
                    ...
                    <div class="product">
                        <img src="{{ url('assets/images/ktgmukenah/3.png') }}" alt="Hijab Bella Square">
                        <h4>Hijab Bella Square</h4>
                        <p>⭐⭐⭐⭐⭐ 5.0/5</p>
                        <p>Rp. 185.000</p>
                    </div>
                    ...
                    <div class="product">
                        <img src="{{ url('assets/images/ktgmukenah/4.png') }}" alt="Hijab Segitiga Inner">
                        <h4>Hijab Segitiga Inner</h4>
                        <p>⭐⭐⭐⭐⭐ 5.0/5</p>
                        <p>Rp. 185.000</p>
                    </div>
                    ...
                    <div class="product">
                        <img src="{{ url('assets/images/ktgmukenah/5.png') }}" alt="Hijab Bella Square">
                        <h4>Hijab Bella Square</h4>
                        <p>⭐⭐⭐⭐⭐ 5.0/5</p>
                        <p>Rp. 185.000</p>
                    </div>
                    ...
                    <div class="product">
                        <img src="{{ url('assets/images/ktgmukenah/6.png') }}" alt="Hijab Segitiga Inner">
                        <h4>Hijab Segitiga Inner</h4>
                        <p>⭐⭐⭐⭐⭐ 5.0/5</p>
                        <p>Rp. 185.000</p>
                    </div>
