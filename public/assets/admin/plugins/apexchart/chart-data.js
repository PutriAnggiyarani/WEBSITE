    ...
    if ($('#sales_charts').length > 0) {
        var options = {
            series: [
                {
                    name: 'Sales',
                    data: [50000000, 45000000, 60000000, 70000000, 50000000, 45000000, 60000000, 70000000, 50000000, 45000000, 60000000, 70000000],
                },
                {
                    name: 'Purchase',
                    data: [-21000000, -54000000, -45000000, -35000000, -21000000, -54000000, -45000000, -35000000, -21000000, -54000000, -45000000, -35000000]
                }
            ],
            ...
            yaxis: {
                labels: {
                    formatter: function (value) {
                        return 'Rp ' + value.toLocaleString(); // Format Rupiah penuh pada tooltip
                    }
                }
            },
            dataLabels: {
                enabled: false // Menonaktifkan angka langsung di atas bar
            },
            tooltip: {
                y: {
                    formatter: function (value) {
